@{
    ...
    FunctionsToExport = @('Connect-CCMServer','Get-CCMServerConfiguration','Import-CCMDeploymentPlan','Import-CCMExampleFunctions','Invoke-CCMApi','New-CCMOutdatedDeploymentPlan','Remove-CCMComputer','Set-CCMServerConfiguration','Wait-CCMDeployment', '*')
